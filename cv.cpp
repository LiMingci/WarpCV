...
#define MKTYPE2_I(NAME) pycv##_##NAME##_specials(); if (!to_ok(&pycv##_##NAME##_Type)) return NULL;
#else
#define MKTYPE2(NAME) MKTYPE2_I(NAME)
#define MKTYPE2_I(NAME) pycv##_##NAME##_specials(); if (!to_ok(&pycv##_##NAME##_Type)) return
#endif

#ifndef MODULE_PREFIX
#define MODULE_PREFIX pycv
#endif
...
#define PYOPENCV_TO  pycv_to
#define PYOPENCV_FROM  pycv_from
